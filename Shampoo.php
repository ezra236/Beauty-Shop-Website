...
<div id="block2" class="content-block">
    <p class="close-btn">X</p>
        <div class="containerp">
            <div class="sidebar">
                ...
                <a href="new.html" class="sidebar-link"><p>New Arrivals </p></a>
                <a href="Bestsellers.html" class="sidebar-link"><p>Bestsellers  </p></a>
            </div>
    ...
    <p class="close-btn">X</p>
        <div class="containerp">
            <div class="sidebar">
                <h2>Makeup</h2>
                <a href="lipG.html" class="sidebar-link"><p>Lip Gloss  </p></a>
                <a href="lipL.html" class="sidebar-link"><p>Lip Liner </p></a>
                <a href="lipS.html" class="sidebar-link"><p>Lipstick </p></a>
                <a href="foundation.html" class="sidebar-link"><p>Foundation </p></a>
                <a href="concealer.html" class="sidebar-link"><p>Concealer </p></a>
                <a href="blush.html" class="sidebar-link"><p>Blush + Highlighter   </p></a>
                <a href="eye.html" class="sidebar-link"><p>Eye Makeup   </p></a>
                <a href="All-products.html" class="sidebar-link button-link"><p>Shop All Makeup</p></a>
            </div>
    ...
    <p class="close-btn">X</p>
        <div class="containerp">
            <div class="sidebar">
                <h2>SkinCare</h2>
                <a href="body.html" class="sidebar-link"><p>Body   </p></a>
                <a href="LipT.html" class="sidebar-link"><p>Lip Care </p></a>
                <a href="Mask.html" class="sidebar-link"><p>Masks  </p></a>
                <a href="EyeC.html" class="sidebar-link"><p>Eye Care  </p></a>
                <a href="All-products.html" class="button-link"><p>Shop All Skincare</p></a>
            </div>
    ...
    <p class="close-btn">X</p>
        <div class="containerp">
            <div class="sidebar">
                ...
                <a href="condition.html" class="sidebar-link"><p>Condition</p></a>
            </div>
...
$sql = "SELECT image_path FROM `right-shampoo` WHERE id = 1";  // Assuming id = 1
$result = $conn->query($sql);
...
?>
    ...
    <div class="inform">
        ...
        <nav class="breadcrumb">
          <a href="Home.php">Home</a> / <a href="productA.php">The Rich One Moisture Repair Shampoo</a>
        </nav>
    
        <div class="product-info">
          <span class="badge">BestSeller</span>
          <h1>The Rich One Moisture Repair Shampoo</h1>
          ...
          <div class="features">
            <div class="feature">
              <img src="hyd.jpeg" alt="Cruelty-free">
              <span>Hydrates Hair</span>
            </div>
            <div class="feature">
              <img src="rep.svg" alt="Non-comedogenic">
              <span>Repair Damage</span>
            </div>
            <div class="feature">
              <img src="smooths.svg" alt="Brightening">
              <span>Snooths</span>
            </div>
            <div class="feature">
              <img src="detangles.svg" alt="Vegan">
              <span>Detangles</span>
            </div>
            <div class="feature">
...
<div class="l">
    <div class="video-container">
        <!-- Remove the controls attribute entirely -->
        <video id="video" poster="b21.jpg">
          <source src="cos.mp4" type="video/mp4">
    ...
    <div class="headerr">
        <h1>STRONGER BY THE STYLE</h1>
        <p>Everyday 'dos, steppin' out styles + everything in between—for all types + textures.</p>
        <a href="#">GET THE LOOKS</a>
    </div>
...
<div class="w">
    <div class="first">
      <div class="grid-container">
        <div class="grid-item">
          <img src="hh.jpeg" alt="Style 1">
        </div>
        <div class="grid-item">
          <img src="hh1.jpeg" alt="Style 2">
        </div>
        <div class="grid-item">
          <img src="hh2.jpeg" alt="Style 3">
        </div>
        <div class="grid-item">
          <img src="hh3.jpeg" alt="Style 4">
        </div>
      </div>
    </div>
    ...
    <div class="third">
        <div class="grid-container">
        <div class="grid-item">
          <img src="hh5.jpeg" alt="Style 6">
        </div>
        <div class="grid-item">
          <img src="hh6.jpeg" alt="Style 7">
        </div>
        <div class="grid-item">
          <img src="mod3.jpg" alt="Style 8">
        </div>
        <div class="grid-item">
            <img src="b21.jpg" alt="Style 8">
          </div>
        </div>
      </div>
...
<div class="s">
    <div class="container">
        <h1>The Rich One Moisture Repair Shampoo</h1>
        <p>Infused with Repenlicore-5 to repair, strengthen, hydrate, smooth + protect.</p>

        <div class="productse">
            <p>Products Used:</p>
            <ul>
                <li>The Rich One Moisture Repair Shampoo</li>
                <li>The Rich One Moisture Repair Conditioner</li>
            </ul>
        </div>
        ...
        <div class="review-box">
            ...
            <ul class="review-details">
                <li>Instantly improves the appearance of hair health</li>
                <li>Enhances natural shine + makes hair feel soft</li>
                <li>Has a rich, plush lather + makes hair feel clean</li>
                <li>Is gentle on the scalp</li>
                <li>Makes hair feel easy to style after rinse out</li>
            </ul>
        </div>

...
<div class="scroll-container">
    <div class="promo-container">
        <div class="promo-text5">
            <?php
            // PHP Code to Fetch Content
            $conn = new mysqli('localhost', 'root', '', 'website_db');
            if ($conn->connect_error) {
                die("Connection failed: " . $conn->connect_error);
            }

            $sql = "SELECT * FROM home_content WHERE id=1"; // Fetch content with ID 1
        ...
        <div class="promo-images">
            ...
            if (!empty($row['image_path'])) {
                echo '<img src="' . htmlspecialchars($row['image_path']) . '" alt="Promotional Image">';
            } else {
    ...
    <div class="promo-container">
        ...
        $conn->close();
        ?>
        <a href="productB.php" class="promo-button">SHOP NOW</a>
    </div>
    ...
    <div class="promo-container">
        ...
        $sql = "SELECT * FROM promo_contents WHERE id=1"; // Fetch content with ID 1
        $result = $conn->query($sql);
        ...
        $conn->close();
        ?>
        <a href="productE.php" class="promo-button">SHOP NOW</a>
    </div>
    <div class="promo-image">
        <?php
        // PHP Code to Display Image
        $conn = new mysqli('localhost', 'root', '', 'website_db');
        $sql = "SELECT * FROM promo_contents WHERE id=1";
        $result = $conn->query($sql);
    ...
    <div class="promo-container">
        ...
        $conn->close();
        ?>
        <a href="productD.php" class="promo-button">SHOP NOW</a>
    </div>
    ...
    <div class="promo-container">
        ...
        $conn->close();
        ?>
        <a href="productC.html" class="promo-button">SHOP NOW</a>
    </div>
...
<div class="container">
  ...
  <div class="monica" id="monica"></div>
  ...
  <div class="exceptional-container">
    <div class="exceptional" id="exceptional">
      <div class="exceptional-item">
        <video src="vid1.mp4" autoplay muted loop  disablePictureInPicture></video>
      </div>
      <div class="exceptional-item">
        <video src="vid2.mp4" autoplay muted loop  disablePictureInPicture></video>
      </div>
      <div class="exceptional-item">
        <video src="vid4.mp4" autoplay muted loop  disablePictureInPicture></video>
      </div>
      <div class="exceptional-item">
        <video src="vid5.mp4" autoplay muted loop  disablePictureInPicture></video>
      </div>
      <div class="exceptional-item">
        <video src="vid6.mp4" autoplay muted loop  disablePictureInPicture></video>
      </div>
      <div class="exceptional-item">
        <video src="vid1.mp4" autoplay muted loop  disablePictureInPicture></video>
      </div>
      ...
      <div class="exceptional-item">
        <video src="vid3.mp4" autoplay muted loop  disablePictureInPicture></video>
      </div>
    </div>
    <div class="arrows">
  ...
  <div class="mobile-exceptional-container">
    <div class="mobile-exceptional" id="mobileExceptional">
        <div class="mobile-exceptional-item">
            <video src="vid1.mp4" loop disablePictureInPicture></video>
        </div>
        <div class="mobile-exceptional-item">
            <video src="vid2.mp4" loop disablePictureInPicture></video>
        </div>
        <div class="mobile-exceptional-item">
            <video src="vid4.mp4" loop disablePictureInPicture></video>
        </div>
        <div class="mobile-exceptional-item">
            <video src="vid5.mp4" loop disablePictureInPicture></video>
        </div>
        <div class="mobile-exceptional-item">
            <video src="vid6.mp4" loop disablePictureInPicture></video>
        </div>
    </div>
</div>

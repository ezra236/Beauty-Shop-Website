...
<head>
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/maskc.css') }}">
    </head>
...
<div class="breadcrumb">
    <a href="{{ route('Home') }}">Home</a> <span>/</span> <span>Maskcare</span>
</div>
...
<script src="{{ asset('js/maskc.js') }}"></script>

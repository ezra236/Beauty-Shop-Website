...
<div class="scroll-container">
    <div class="promo-container">
        <div class="promo-text5">
            ...
            $conn->close();
            ?>
           <a href="{{ route('productA') }}" class="promo-button">SHOP NOW</a>
    ...
    <div class="promo-container">
        ...
        $conn->close();
        ?>
        <a href="{{ route('productB') }}" class="promo-button">SHOP NOW</a>
    ...
    <div class="promo-container">
        ...
        $conn->close();
        ?>
        <a href="{{ route('productE') }}" class="promo-button">SHOP NOW</a>
    ...
    <div class="promo-container">
        ...
        $conn->close();
        ?>
        <a href="{{ route('productD') }}" class="promo-button">SHOP NOW</a>
    ...
    <div class="promo-container">
        ...
        $conn->close();
        ?>
        <a href="{{ url('/productC') }}" class="promo-button">SHOP NOW</a>
    </div>
...
<div class="classic-container">
    <div class="classic-scroll" id="classicScroll">
      <div class="classic-item">
        <img id="item1" src="{{ asset('images/b7.jpg') }}" alt="Item 1">
        <h3>Diamond Bomb</h3>
        <div class="stars">
      ...
      <div class="classic-item">
        <img id="item2" src="{{ asset('images/drop.jpg') }}" alt="Item 2">
        <h3>Eaze Drop Lit</h3>
        <div class="stars">
            <div class="star black"></div>
            <div class="star black"></div>
      ...
      <div class="classic-item">
        <img id="item3" src="{{ asset('images/lip.jpg') }}" alt="Item 3">
      ...
      <div class="classic-item">
        <img id="item4" src="{{ asset('images/bm3.jpg') }}" alt="Item 4">
      ...
      <div class="classic-item">
        <img id="item5" src="{{ asset('images/g.jpg') }}" alt="Item 5">
        <h3>Flash Nap</h3>
        <div class="stars">
            <div class="star black"></div>
            <div class="star black"></div>
      ...
      <div class="classic-item">
        <img id="item6" src="{{ asset('images/b20.jpg') }}" alt="Item 6">
      ...
      <div class="classic-item">
        <img id="item7" src="{{ asset('images/bm1.jpg') }}" alt="Item 7">
        <h3>Fenty Glow</h3>
        <div class="stars">
            <div class="star black"></div>
            <div class="star black"></div>
      ...
      <div class="classic-item">
        <img id="item8" src="{{ asset('images/skinca.jpg') }}" alt="Item 8">
        <h3>Skin Cream</h3>
        <div class="stars">
            <div class="star black"></div>
            <div class="star black"></div>
...
<div class="containerd">
    ...
    <button id="shopNowButton" data-url="{{ route('ckary_lip') }}">SHOP NOW</button>
...
<div class="container">
    <div class="box box1" id="box1">
        <img src="{{ asset('images/dis4.jpg') }}">
    </div>
    <div class="box box2" id="box2">
        <img src="{{ asset('images/dis2.jpg') }}">
    </div>
    <div class="box box3" id="box3">
        <img src="{{ asset('images/drop.jpg') }}">
    </div>
    <div class="box box4" id="box4">
        <img src="{{ asset('images/dis1.jpg') }}">
    </div>
  </div>

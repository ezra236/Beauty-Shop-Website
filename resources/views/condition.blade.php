...
<div class="breadcrumb">    
    <a href="{{ route('Home') }}">Home</a> <span>/</span> <span>condition</span>
</div>
...
<div class="prod">
    <div class="boxx">
        <h1>REPARATIVE HAIRCARE FOR ALL STYLES</h1>
        <p>Clinically tested to repair, strengthen</p>
    </div>
    <div class="k">
        <div class="ser">
            <img src="{{ asset('images/pi.jpeg') }}">
        </div>
    </div>
</div>

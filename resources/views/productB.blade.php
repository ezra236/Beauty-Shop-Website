...
// Retrieve the most recently updated record
$sql = "SELECT image_path1, image_path2 FROM promo_content ORDER BY updated_at DESC LIMIT 1";
...
if ($result->num_rows > 0) {
    ...
    $imagePath1 = $row['image_path1'];
    $imagePath2 = $row['image_path2'];
} else {
    echo "No promotional content found.";
...
<head>
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/productB.css') }}">
    </head>
...
<div class="inform">
    ...
    <nav class="breadcrumb">
        <a href="{{ route('Home') }}">Home</a> / <a href="{{ url('/productB') }}">Cherry Dub Pore Purify'r Gel Cleanser with Niacinamide + Aloe Juice</a>
    </nav>
    ...
    <div class="product-info">
      ...
      <div class="features">
        <div class="feature">
          <img src="{{ asset('images/p1.jpeg') }}" alt="Cruelty-free">
          <span>Cruelty-free</span>
        </div>
        <div class="feature">
          <img src="{{ asset('images/p2.jpeg') }}" alt="Non-comedogenic">
          <span>Non-comedogenic</span>
        </div>
        <div class="feature">
          <img src="{{ asset('images/p3.jpeg') }}" alt="Brightening">
          <span>Brightening</span>
        </div>
        <div class="feature">
          <img src="{{ asset('images/p4.jpeg') }}" alt="Vegan">
          <span>Vegan</span>
        </div>
        <div class="feature">
          <img src="{{ asset('images/p5.jpeg') }}" alt="Recyclable">
 ...
 <div class="ingredients-section">
    ...
    <div class="ingredient-cards">
      <div class="ingredient-card">
        <img src="{{ asset('images/ingr.jpeg') }}" alt="Triple Cherry Complex">
      ...
      <div class="ingredient-card">
        <img src="{{ asset('images/ingr1.jpeg') }}" alt="Niacinamide (Vitamin B3)">
        <h3>Niacinamide (Vitamin B3)</h3>
        <p>Refines pores + skin's texture</p>
      </div>
      <div class="ingredient-card">
        <img src="{{ asset('images/ingr1.jpeg') }}" alt="Aloe Juice">
        <h3>Aloe Juice</h3>
...
<div class="classic-container">
    <div class="classic-scroll" id="classicScroll">
        ...
        <div class="classic-item">
            <img id="item1" src="{{ asset('images/b7.jpg') }}" alt="Item 1" data-hover="{{ asset('images/ap.jpg') }}">
            <h3>Diamond Bomb</h3>
            <div class="stars">
        ...
        <div class="classic-item">
            <img id="item2" src="{{ asset('images/drop.jpg') }}" alt="Item 2" data-hover="{{ asset('images/b11.jpg') }}">
            <h3>Eaze Drop Lit</h3>
            <div class="stars">
                <div class="star black"></div>
                <div class="star black"></div>
        ...
        <div class="classic-item">
            <img id="item3" src="{{ asset('images/lip.jpg') }}" alt="Item 3" data-hover="{{ asset('images/lip2.jpg') }}">
        ...
        <div class="classic-item">
            <img id="item4" src="{{ asset('images/bm3.jpg') }}" alt="Item 4" data-hover="{{ asset('images/ap2.jpg') }}">
        ...
        <div class="classic-item">
            <img id="item5" src="{{ asset('images/g.jpg') }}" alt="Item 5" data-hover="{{ asset('images/ap3.jpg') }}">
            <h3>Flash Nap</h3>
            <div class="stars">
                <div class="star black"></div>
                <div class="star black"></div>
        ...
        <div class="classic-item">
            <img id="item6" src="{{ asset('images/b20.jpg') }}" alt="Item 6" data-hover="{{ asset('images/ap1.jpg') }}">
        ...
        <div class="classic-item">
            <img id="item7" src="{{ asset('images/bm1.jpg') }}" alt="Item 7" data-hover="{{ asset('images/lips.jpg') }}">
            <h3>Fenty Glow</h3>
            <div class="stars">
                <div class="star black"></div>
                <div class="star black"></div>
        ...
        <div class="classic-item">
            <img id="item8" src="{{ asset('images/skinca.jpg') }}" alt="Item 8" data-hover="{{ asset('images/ap3.jpg') }}">
            <h3>Skin Cream</h3>
            <div class="stars">
                <div class="star black"></div>
                <div class="star black"></div>
...
<div class="how-to-use-section">
    ...
    <div class="steps">
      <div class="step">
        <img src="{{ asset('images/st.jpeg') }}" alt="Step 1 - Cleanse">
        <h3>STEP 1</h3>
        <p>Cleanse</p>
      </div>
      <div class="step">
        <img src="{{ asset('images/st1.jpeg') }}" alt="Step 2 - Tone">
        <h3>STEP 2</h3>
        <p>Tone</p>
      </div>
      <div class="step">
        <img src="{{ asset('images/st2.jpeg') }}" alt="Step 3 - Protect">
        <h3>STEP 3</h3>
        <p>Protect</p>
      </div>
      <div class="step">
        <img src="{{ asset('images/st2.jpeg') }}" alt="Step 4 - Invisimatte">
        <h3>STEP 4</h3>
        <p>Invisimatte</p>
      </div>
    </div>
  ...
  <table>
        <tr>
            ...
            <th class="product-cell product-1">
                <img src="{{ asset('images/lips.jpg') }}" alt="Cherry Dub" class="product-imagep"><p>Cherry Dub Pore Purify'r + Aloe Juice</p><p>KSh5,500.00</p>
            </th>
            <th class="product-cell product-2">
                <img src="{{ asset('images/lipss.jpg') }}" alt="Total Cleans'r Remove-It-All Cleanser" class="product-imagep"><p>Total Cleans'r Remove-It-All Cleanser with Barbados</p> <p>KSh2,600.00</p>
            </th>
            <th class="product-cell product-3">
                <img src="{{ asset('images/bl.jpg') }}" alt="Melt Awf Jelly Oil Makeup-Melting Cleanser" class="product-imagep"><p>Melt Awf Jelly Oil Makeup-Melting Cleanser</p><p> Ksh500.00</p>
            </th>
            <th class="product-cell product-4">
                <img src="{{ asset('images/skinca.jpg') }}" alt="Cocoa Cleans'r Soothing Bar" class="product-imagep"><p>Cocoa Cleans'r Soothing All-Over Coconut Oil + Shea</p><p>KSh2,500.00</p>
            </th>
        </tr>
        <tr>
...
$sql = "SELECT review, headline, name, age_range, gender, created_at FROM reviews1 ORDER BY id DESC LIMIT 1";
$result = $conn->query($sql);
$row = $result->fetch_assoc();
?>
...
<script src="{{ asset('js/productB.js') }}"></script>

...
<head>
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/EyeCare.css') }}">
    </head>
...
<div class="breadcrumb">
    <a href="{{ route('Home') }}">Home</a> <span>/</span> <span>Eye Care</span>
</div>
...
<div class="fs">
    <div class="containerm">
        ...
        <div class="text-section">
            ...
            <h2>Ckay Eye Care – Ultimate Brightness</h2>
            <p>
              Specially formulated for the delicate eye area, Ckay Eye Care offers a comprehensive solution designed to refresh, brighten, and protect your eyes. Whether you're looking to reduce puffiness, diminish dark circles, or smooth fine lines, this innovative formula harnesses the power of potent botanical extracts, peptides, and antioxidants that work to rejuvenate the sensitive skin around your eyes.
              <br><br>
              Experience a visibly refreshed look as Ckay Eye Care soothes tired eyes and restores a luminous radiance. Its gentle yet effective formula hydrates and revitalizes, ensuring that every glance exudes clarity and vibrancy. Trust in Ckay Eye Care – because your eyes deserve to shine with confidence.
            </p>
            <a href="{{ url('/care') }}" class="shop-btn">SHOP NOW</a>
        </div>
    </div>
    </div>
    </div>
...
<script src="{{ asset('js/EyeCare.js') }}"></script>

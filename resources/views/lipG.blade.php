...
<head>
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/lipG.css') }}">
    </head>
...
<div class="breadcrumb">
    <a href="{{ route('Home') }}">Home</a> <span>/</span> <span>Lip Gloss</span>
</div>
...
<div class="prod">
    ...
    <div class="k">
        <div class="ser">
            <img src="{{ asset('images/LIPSo.jpeg') }}">
        </div>
    </div>
</div>
...
<script src="{{ asset('js/lipG.js') }}"></script>

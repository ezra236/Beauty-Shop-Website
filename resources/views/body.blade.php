...
<div class="breadcrumb">
        <a href="{{ route('Home') }}">Home</a> <span>/</span> <span>Body</span>
</div>
...
<div class="l">
    <div class="video-container">
        ...
        <video id="video" poster="{{ asset('images/lo.jpeg') }}">
          <source src="{{ asset('images/sexz.mp4') }}" type="video/mp4">
...
<div class="containerm">
    ...
    <div class="text-section">
        <p class="cv">Brand Focus</p>
        <h2>Ckay Skin – Ultimate Care for Every Body</h2>
        <p>Designed for all body types, Ckay Skin is the ultimate skincare solution that nourishes, hydrates, and revitalizes your skin. Whether your skin is dry, oily, sensitive, or combination, this advanced formula works to restore balance and radiance. Infused with natural botanical extracts, vitamins, and antioxidants, Ckay Skin helps combat environmental stressors, uneven texture, and dullness, leaving your skin smooth, soft, and glowing.

            From daily hydration to deep repair, this powerful skincare range is designed to lock in moisture, enhance elasticity, and promote a healthy, youthful appearance. Free from harsh chemicals and artificial additives, Ckay Skin is gentle yet effective, making it perfect for everyday use. Experience the confidence of beautifully nourished skin with Ckay Skin – because every body deserves the best.</p>
        <a href="{{ url('/fine') }}" class="shop-btn">SHOP NOW</a>
    </div>
</div>
</div>
</div>

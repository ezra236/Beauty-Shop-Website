...
<head>
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/lipL.css') }}">
    </head>
...
<div class="breadcrumb">
    <a href="{{ route('Home') }}">Home</a> <span>/</span> <span>Lip Liner</span>
</div>
...
<div class="prod">
    ...
    <div class="k">
        <div class="ser">
            <img src="{{ asset('images/lipl.jpeg') }}">
        </div>
    </div>
</div>
...
<script src="{{ asset('js/lipL.js') }}"></script>

...
<head>
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/Shampoo.css') }}">
    </head>
...
?>
    ...
    <div class="inform">
        ...
        <a href="{{ route('Home') }}">Home</a> / <a href="{{ url('/shampoo') }}">Shampoo</a> 
        </nav>
        ...
        <div class="product-info">
          ...
          <div class="features">
            <div class="feature">
              <img src="{{ asset('images/hyd.jpeg') }}" alt="Cruelty-free">
              <span>Hydrates Hair</span>
            </div>
            <div class="feature">
              <img src="{{ asset('images/rep.svg') }}" alt="Non-comedogenic">
              <span>Repair Damage</span>
            </div>
            <div class="feature">
              <img src="{{ asset('images/smooths.svg') }}" alt="Brightening">
              <span>Snooths</span>
            </div>
            <div class="feature">
              <img src="{{ asset('images/detangles.svg') }}" alt="Vegan">
              <span>Detangles</span>
            </div>
            <div class="feature">
...
<div class="l">
    <div class="video-container">
        ...
        <video id="video" poster="{{ asset('images/b21.jpg') }}">
          <source src="{{ asset('images/cos.mp4') }}" type="video/mp4">
...
<div class="w">
    <div class="first">
      <div class="grid-container">
        <div class="grid-item">
          <img src="{{ asset('images/hh.jpeg') }}" alt="Style 1">
        </div>
        <div class="grid-item">
          <img src="{{ asset('images/hh1.jpeg') }}" alt="Style 2">
        </div>
        <div class="grid-item">
          <img src="{{ asset('images/hh2.jpeg') }}" alt="Style 3">
        </div>
        <div class="grid-item">
          <img src="{{ asset('images/hh3.jpeg') }}" alt="Style 4">
        </div>
      </div>
    </div>
    ...
    <div class="second">
        <div class="grid-containerr">
            <div class="grid-itemm">
              <img src="{{ asset('images/hh4.jpeg') }}" alt="Style 1">
            </div>
        </div>
    </div>
    ...
    <div class="third">
        <div class="grid-container">
        <div class="grid-item">
          <img src="{{ asset('images/hh5.jpeg') }}" alt="Style 6">
        </div>
        <div class="grid-item">
          <img src="{{ asset('images/hh6.jpeg') }}" alt="Style 7">
        </div>
        <div class="grid-item">
          <img src="{{ asset('images/mod3.jpg') }}" alt="Style 8">
        </div>
        <div class="grid-item">
            <img src="{{ asset('images/b21.jpg') }}" alt="Style 8">
          </div>
        </div>
      </div>
...
<div class="s">
    ...
    <div class="image">
        <img src="{{ asset('images/blac.jpeg') }}">
    </div>
 </div>
...
<script src="{{ asset('js/Shampoo.js') }}"></script>

...
<head>
        ...
        <link rel="stylesheet" href="{{ asset('css/productC.css') }}">
</head>
<body>
...
<div class="prod">
    <div class="boxx">
        <h1>Our Exclusive Face Cream</h1>
        <p>Stay stunning with the right skin</p>

        <button class="bt">Shop Now</button>
    </div>
    <img src="{{ asset('images/prc2.jpeg') }}">
</div>
...
<script src="{{ asset('js/productC.js') }}"></script>

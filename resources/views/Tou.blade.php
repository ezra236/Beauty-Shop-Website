...
<div class="terms-of-use">
    <h1>Terms of Use</h1>
    <p>Welcome to ckary, a premier beauty company dedicated to enhancing your natural beauty. By accessing or using our website, you agree to be bound by these Terms of Use. Please read them carefully.</p>
    
    <h2>Acceptance of Terms</h2>
    <p>By using ckary's website, you acknowledge that you have read, understood, and agree to these Terms of Use. If you disagree with any part of these terms, please refrain from using our services.</p>
    
    <h2>Use of the Website</h2>
    <p>You are granted a limited, non-exclusive, and revocable license to access and use the website for personal, non-commercial purposes only. Any misuse or unauthorized use of our website may result in termination of access and legal action.</p>
    
    <h2>Intellectual Property Rights</h2>
    <p>All content on this website, including but not limited to text, images, logos, and graphics, is the property of ckary or its content suppliers and is protected by international copyright laws.</p>
    
    <h2>Privacy</h2>
    <p>Your privacy is important to us. Please review our <a href="#">Privacy Policy</a> to understand how we collect, use, and safeguard your personal information.</p>
    
    <h2>Modifications to Terms</h2>
    <p>ckary reserves the right to update or modify these Terms of Use at any time without prior notice. Your continued use of the website following any changes constitutes acceptance of the new terms.</p>
    
    <h2>Contact Information</h2>
    <p>If you have any questions about these Terms of Use, please contact us at <a href="mailto:info@ckary.com">info@ckary.com</a>.</p>
  </div>
  

  <script src="{{ asset('js/Tou.js') }}"></script>

...
<head>
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/concealer.css') }}">
    </head>
...
<div class="breadcrumb">
        <a href="{{ route('Home') }}">Home</a> <span>/</span> <span>Concealer</span>
</div>
...
<div class="prod">
    ...
    <div class="k">
        <div class="ser">
            <img src="{{ asset('images/conce.jpeg') }}">
        </div>
    </div>
</div>
...
<script src="{{ asset('js/concealer.js') }}"></script>

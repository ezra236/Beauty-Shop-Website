...
<div class="refund-policy">
    <h2>Refund Policy</h2>
    <p>At CKary, we are dedicated to providing our customers with exceptional beauty products and outstanding service. If you are not completely satisfied with your purchase, our refund policy ensures that you can shop with confidence.</p>
    ...
    <ul>
      ...
      <li>The product has a manufacturing defect or quality issue.</li>
    </ul>
    
    <h3>How to Request a Refund</h3>
    <p>To request a refund, please follow these steps:</p>
    <ul>
      <li>Contact our customer service team at <a href="mailto:support@ckary.com">support@ckary.com</a> within 30 days of purchase.</li>
      <li>Provide your order number and a detailed explanation of the issue.</li>
      <li>Return the product in its original packaging along with any included accessories.</li>
    </ul>
    
    <h3>Refund Process</h3>
    <p>Once we receive your return and verify the product’s condition, we will notify you of the approval or rejection of your refund request. If approved, your refund will be processed within 7-10 business days and credited to your original payment method.</p>
    
    <h3>Exceptions</h3>
    <p>Please note:</p>
    <ul>
      <li>Personalized or custom-made products are not eligible for refunds.</li>
      <li>Products marked as “final sale” cannot be returned.</li>
    </ul>
    
    <p>If you have any questions regarding our refund policy, please contact our customer service team at <a href="mailto:support@ckary.com">support@ckary.com</a>.</p>
  </div>

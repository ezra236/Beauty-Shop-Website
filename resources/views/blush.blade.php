...
<head>
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/blush.css') }}">
    </head>
...
<div class="breadcrumb">
    <a href="{{ route('Home') }}">Home</a> <span>/</span> <span>blush</span>
</div>
...
<script src="{{ asset('js/blush.js') }}"></script>

...
<head>
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/Mask.css') }}">
    </head>
...
<div class="breadcrumb">
    <a href="{{ route('Home') }}">Home</a> <span>/</span> <span>Mask</span>
</div>
...
<div class="prod">
    <div class="boxx">
        ...
        <p>Who doesnt love a brighter lips</p>

        <button class="bt">Shop Now</button>
    </div>
    <div class="k">
        <div class="ser">
            <img src="{{ asset('images/lip.jpg') }}">
        </div>
    </div>
</div>
...
<div class="fs">
    <div class="containerm">
        ...
        <div class="text-section">
            ...
            <h2>Ckay Masks – Ultimate Care </h2>
            <p>Designed for all skin types, Ckay Mask is the perfect skincare solution that purifies, hydrates, and revitalizes your complexion. Whether your skin is dry, oily, sensitive, or combination, this advanced formula works to restore clarity and radiance. Infused with natural botanical extracts, vitamins, and antioxidants, Ckay Mask helps remove impurities, unclog pores, and reduce dullness, leaving your skin fresh, soft, and glowing.

                From deep cleansing to intense nourishment, this powerful face mask range is designed to detoxify, refine texture, and promote a healthy, youthful glow. Free from harsh chemicals and artificial additives, Ckay Mask is gentle yet effective, making it ideal for regular use. Experience the confidence of beautifully renewed skin with Ckay Mask – because every face deserves the best.</p>
            <a href="{{ url('/maskcare') }}" class="shop-btn">SHOP NOW</a>
        </div>
    </div>
    </div>
    </div>

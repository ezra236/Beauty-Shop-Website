...
$sql = "SELECT image_path FROM home_content WHERE id = 1"; // Fetching the first record as an example
...
<head>
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/productA.css') }}">
    </head>
...
<div class="inform">
    ...
    <nav class="breadcrumb">
      <a href="{{ route('Home') }}">Home</a> / <a href="{{ url('/productA') }}">Cherry Dub Pore Purify'r Gel Cleanser with Niacinamide + Aloe Juice</a>
    </nav>
...
<script src="{{ asset('js/productA.js') }}"></script>

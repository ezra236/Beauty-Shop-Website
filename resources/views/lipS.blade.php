...
<head>
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('css/lipS.css') }}">
    </head>
...
<div class="breadcrumb">
    <a href="{{ route('Home') }}">Home</a> <span>/</span> <span>LipStick</span>
</div>
...
<div class="prod">
    ...
    <div class="k">
        <div class="ser">
            <img src="{{ asset('images/lipo.jpeg') }}">
        </div>
    </div>
</div>
...
<script src="{{ asset('js/lipS.js') }}"></script>

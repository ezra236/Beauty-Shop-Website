...
function updateMonicaContent(headerText, paragraphText, buttonLink) {
  ...
  function toggleBox(clickedBox) {
    ...
    if (clickedBox.classList.contains('clicked')) {
      ...
      if (clickedBox === box1) {
        monica.style.left = '5%';
        updateMonicaContent('YOUR WINNING ROUTINE', 'Whether you got dry, oil or combo skin', 'lipG');
      } else if (clickedBox === box2) {
        monica.style.left = '21%';
        updateMonicaContent('ALWAYS BETTER TOGETHER', 'Its legendary lipcare', 'shampoo');
      } else if (clickedBox === box3) {
        monica.style.left = '38%';
        updateMonicaContent('HAIR FOR THE HYDRATION', 'Secure Our reparative lineup', 'body');
      } else if (clickedBox === box4) {
        monica.style.left = '55%';
        updateMonicaContent('BOLD SCENT YOU WONT FORGET', 'Step out in Ckay spicy', 'all');
      }
    }
  ...
  toggleBox(box4);
    ...
    Array.from(items).forEach(item => {
        ...
        item.addEventListener('mouseover', () => {
          if (document.userInteraction) { // Ensure the user has interacted
            video.muted = false; 
...
const imageSources = {
    item1: { original: '/images/b7.jpg', hover: '/images/ap.jpg' },
    item2: { original: '/images/drop.jpg', hover: '/images/b11.jpg' }, // Adjust hover image path as needed
    item3: { original: '/images/lip.jpg', hover: '/images/lip2.jpg' }, // Adjust hover image path as needed
    item4: { original: '/images/bm3.jpg', hover: '/images/ap2.jpg' }, // Adjust hover image path as needed
    item5: { original: '/images/g.jpg', hover: '/images/ap3.jpg' }, // Adjust hover image path as needed
    item6: { original: '/images/b20.jpg', hover: '/images/ap1.jpg' }, // Adjust hover image path as needed
    item7: { original: '/images/bm1.jpg', hover: '/images/lips.jpg' }, // Adjust hover image path as needed
    item8: { original: '/images/skinca.jpg', hover: '/images/ap3.jpg' } // Adjust hover image path as needed
};
...
const hoverImages = {
    carouselItem1: { original: '/images/purp.jpg', hover: '/images/ap.jpg' },
    carouselItem2: { original: '/images/t4.jpg', hover: '/images/b11.jpg' },
    carouselItem3: { original: '/images/t10.jpg', hover: '/images/lip2.jpg' },
    carouselItem4: { original: '/images/t1w.jpg', hover: '/images/ap2.jpg' },
    carouselItem5: { original: '/images/drop.jpg', hover: '/images/ap3.jpg' },
    carouselItem6: { original: '/images/lip.jpg', hover: '/images/ap1.jpg' },
    carouselItem7: { original: '/images/bm3.jpg', hover: '/images/lips.jpg' },
    carouselItem8: { original: '/images/g.jpg', hover: '/images/ap3.jpg' }
};
